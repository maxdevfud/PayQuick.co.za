...
namespace PayQuick
{
    public partial class frmSalarySlips : Form
    {
        ...
        private void frmSalarySlips_Load(object sender, EventArgs e)
        {
            ...
            report.SetParameterValue("EmployerAddress", workingEmplr.addr1 + " | " + workingEmplr.addr2 + " | " + workingEmplr.addr3 + " | " + workingEmplr.addr4);
            ...
            report.SetParameterValue("pqGEL", pqGEL);
